...
from verl.models.mcore.dta import DTASelfAttention, TreeAttentionContext, use_tree_attention_context
from verl.models.mcore.dta import attention as dta_attention
...
class _StubDTASelfAttention(DTASelfAttention):
    """Small fixture that exercises DTA orchestration without a ModuleSpec."""
