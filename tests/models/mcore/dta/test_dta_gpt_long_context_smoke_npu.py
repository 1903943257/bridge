...
"""DTA-only long-context smoke test.
...
poison the device context and invalidate the subsequent DTA run.
"""
...
def test_dta_16k_prefix_8k_suffix_forward_backward_is_finite(monkeypatch):
    ...
    _assert_finite(prefix_logits, "DTA 16K prefix logits")
    ...
    _assert_finite(suffix_logits, "DTA 8K suffix logits")
    ...
    _assert_finite(loss, "DTA long-context loss")
    loss.backward()
