...
from . import test_tpr_twenty_step_correctness_npu as synthetic_correctness
...
pytestmark = pytest.mark.skipif(
    os.getenv("TPR_RUN_QWEN_20_STEP_CORRECTNESS") != "1",
    reason="Set TPR_RUN_QWEN_20_STEP_CORRECTNESS=1 for the real Qwen3 20-step experiment",
)
